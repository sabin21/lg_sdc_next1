...
export default function HeroScene(props) {
  ...
  return (
    <Canvas onClick={click} shadows dpr={[1, 1.5]} gl={{ antialias: false }} camera={{ position: [0, 0, 17], fov: 17.5, near: 1, far: 20 }} {...props}>
...
function Model({ children, color = 'white', roughness = 0, ...props }) {
    ...
    return (
      <mesh ref={ref} castShadow receiveShadow scale={0.8} geometry={nodes.cube.geometry}>
